...
def detect_people(frame, net, ln, personIdx=0):
    ...
    # construct a blob from the input frame and then perform a forward pass of the YOLO object detector, giving us our bounding boxes and associated     
    #probabilities
    ...
    for output in layerOutputs:
        ...
        for detection in output:
            ...
            if classID == personIdx and confidence > MIN_CONF:
                # scale the bounding box coordinates back relative to the size of the image, keeping in mind that YOLO actually returns the center 
                #(x, y)-coordinates of the bounding box followed by the boxes' width and height
